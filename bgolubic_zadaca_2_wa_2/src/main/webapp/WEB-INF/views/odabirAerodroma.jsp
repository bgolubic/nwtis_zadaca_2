...
<% ServletContext sc = request.getServletContext();
	...
	<form method="get" action="${pageContext.servletContext.contextPath}/mvc/aerodromi/icao">
		<label for="icao">ICAO:</label>
		<input name="icao" type="text" /><br><br>
		<input type="submit" value="Prikaži aerodrom" /><br>
		</form>
</body>
</html>