...
<head>
<meta charset="UTF-8">
<title>Odabir polazaka od aerodroma</title>
</head>
<body>
<% ServletContext sc = request.getServletContext();
	...
	<form method="get" action="${pageContext.servletContext.contextPath}/mvc/letovi/polasciOdAerodroma">
		<label for="icao">ICAO:</label>
		<input name="icao" type="text" /><br>
